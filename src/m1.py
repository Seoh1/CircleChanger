...
class CircleChanger(object):
    ...
    def swell_or_shrink_once(self, amount_to_swell_or_shrink):
        ...
        r_index = random.randrange(3,16)
        r_colors = self.colors[r_index]
        self.circle.fill_color = r_colors
    ...
    def swallow(self, other_circle_changer):
        ...
        new_center = other_circle_changer.circle.center.halfway_to(self.circle.center)
        new_radius = other_circle_changer.get_distance_from(self.circle.center)/2
        return CircleChanger(new_center.x, new_center.y, new_radius, 'red', self.colors + other_circle_changer.colors)
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self. orignal_color
